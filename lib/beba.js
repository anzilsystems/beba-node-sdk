...
var self = module.exports = {
    ...
    getCouriers: function (request_options, callback) {
        ...
        var bodyString = {
            ...
            "redirect_uri": request_options.callbackURL,
        };
        // request option
        var options = {
            uri: '',
 ...
 */
  ...
  */
    ...
    updateOrderStatus: function (request_options, callback) {
         ...
         */
        if (process.env.BEBA_ENV === 'sandbox') {
            options.uri = endpoint.sandbox_urls.updateOrderStatus + "/" + request_options.unique_id;
        } else if (process.env.BEBA_ENV === 'live') {
            options.uri = endpoint.live_urls.updateOrderStatus + "/" + request_options.unique_id;
        }
        /**
         * Get token and use it to make a request.
         */
