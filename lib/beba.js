...
var self = module.exports = {
  ...
  */
    ...
    */
    ...
    /**
     * Use this function to obtain the details of an order as well as tracking information based on unique order id
     * 
     * @param $unique_id | UUID Version 4
  ...
  */
    ...
    getOrderDetail: function (request_options, callback) {
        // request option
        var options = {
            uri: '',
            port: 443,
         ...
         */
        if (process.env.BEBA_ENV === 'sandbox') {
            options.uri = endpoint.sandbox_urls.getOrderDetail + "/" + request_options.unique_id;
        } else if (process.env.BEBA_ENV === 'live') {
            options.uri = endpoint.live_urls.getOrderDetail + "/" + request_options.unique_id;
        }
        /**
         * Get token and use it to make a request.
         */
...
*/
    ...
    createShipment: function (request_options, callback) {
        ...
        var bodyString = {
            ...
            "item_detail": request_options.item_detail,
