...
var sandbox_urls = exports.sandbox_urls = {
    ...
    'auth_url': "https://www.pikieglobal.com/api/v1/oauth2/token?grant_type=client_credentials",
    'getCouriers': "https://www.pikieglobal.com/api/v1/get_couriers",
...
var live_urls = exports.live_urls = {
    ...
    'auth_url': "https://api.pikieglobal.com/api/v1/oauth2/token?grant_type=client_credentials",
